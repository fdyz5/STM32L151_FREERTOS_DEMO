...
//		 struct 
//		{
//				uint32_t DATA_READY_BIT    : 1;//µç³ØµÍµçÁ¿Òì³£
//				uint32_t DATA_READY_BIT1  : 1;//×óÂÖÐü¿ÕÒì³£
//				uint32_t DATA_READY_BIT2 : 1;//ÓÒÂÖÐü¿ÕÒì³£
//				uint32_t DropLFAbn  : 1;//×óÇ°Ðü¿Õ´«¸ÐÆ÷Ðü¿ÕÒì³£
//				uint32_t DropLBAbn  : 1;//×óÇ°Ðü¿Õ´«¸ÐÆ÷Ðü¿ÕÒì³£
//				uint32_t DropRFAbn  : 1;//×óÇ°Ðü¿Õ´«¸ÐÆ÷Ðü¿ÕÒì³£
//				uint32_t DropRBAbn  : 1;//×óÇ°Ðü¿Õ´«¸ÐÆ÷Ðü¿ÕÒì³£
//				uint32_t UltraSonicAbn     : 1;//³¬Éù²¨¼ì²âµ½ÕÏ°­ÎïÒì³£
//				uint32_t LeftCollisionAbn  : 1;//×óÅö×²
//				uint32_t RightCollisionAbn : 1;//ÓÒÅö×²
//				uint32_t DustBoxAbn        : 1;//³¾ºÐ²»ÔÚ 
//				uint32_t InRechargeStand   : 1;//ÊÇ·ñÔÚ³äµç×ù
//		}Data_Sta_en;
//}unionData_Sta;
...
/****************xPortGetFreeHeapSize »ñÈ¡Ê£Óà¶Ñ¿Õ¼ä²âÊÔ****************/
// ???????
#if FREEHEAPSIZE_EN
typedef struct {
    uint8_t data[50]; // ??????????100??
